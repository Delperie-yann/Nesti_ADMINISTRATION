...
<div class="container bg-white d-flex flex-column align-items-left" id="recipes">
  <div class="d-flex flex-row justify-content-between">
    ...
    <div>
      <a href="<?php BASE_URL ?>index.php?loc=users&action=creation" class="btn mb-1 border align-self-end"><img id="add" src="<?php BASE_URL ?>public/images/add.png" alt="" width="20px" height="20px"> Ajouter</a>
    </div>
  </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <p class="modal-body">  <i class="fas fa-exclamation-triangle fa-3x text-danger"></i>Voulez vous vraiment supprimer <?=$value->getLastname();?> ?</p>
                </div>

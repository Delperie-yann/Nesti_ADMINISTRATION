    ...
    <div class="container bg-white d-flex flex-column align-items-left" id="recipes">
        <div class="d-flex flex-row justify-content-between">
            <nav class="navbar navbar-white bg-white pl-0">
                <form class="form-inline">
                    ...
                    <img id="searchRecipe" src="<?= BASE_URL ?>public/images/search.png" alt="" class="imageMin">
                </form>
            </nav>
            <div>
                <a href="<?= BASE_URL ?>users/creation" class="btn mb-1 border align-self-end"><img id="add" src="<?= BASE_URL ?>public/images/add.png" alt="" class="imageMin"> Ajouter</a>
            </div>
        </div>
        ...
        <table class="table">
            ...
            ?>
                ...
                <tr>
                    <td class="font-weight-bold"><?= $value->getIdUser(); ?></td>

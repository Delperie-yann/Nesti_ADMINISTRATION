            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="col d-flex justify-content-between flex-column p-0">
                        <div class="d-flex justify-content-end"><input type="number" min="0" max="5" class="w-25 mt-2 mb-2" value="<?= $recipe->getDifficulty()  ?>"></div>
                        <div class="d-flex justify-content-end"><input type="number" min="0" class="w-25 mt-2 mb-2" value="<?= $recipe->getPortions()  ?>"></div>
                        <div class="d-flex justify-content-end"><input type="text" class="w-25 mt-2 mb-2" value="<?= $recipe->getPreparationTime()  ?>"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="row mt-4 h-50">
                    <div class="col-sm-1"></div>
                    <div class="col">
                        <button class="btn w-100 h-25" onclick="addTextArea()">
            ...
            <div class="col-sm-4">
                ...
                <div class="row">
                    <div class="col-md-5"><input type="number" min="0" id="ingQty" class="w-100 h-100"></div>
                    <div class="col-md-5"><input type="text" id="ingUnit" class="w-100 h-100"></div>
                    <div class="col-md-2 d-flex justify-content-end"><button type="submit" class="btn valid" onclick="addIngredient()">Ok</button></div>
                </div>
            </div>
        </div>
    </div>

            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="col d-flex justify-content-between flex-column p-0">
                        <div class="d-flex justify-content-end"><input type="number" min="0" max="5" class="w-25 mt-2 mb-2"></div>
                        <div class="d-flex justify-content-end"><input type="number" min="0" class="w-25 mt-2 mb-2"></div>

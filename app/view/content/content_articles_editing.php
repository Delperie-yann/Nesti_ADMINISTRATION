        ...
        <div class="row mt-3">
            <form action="<?= BASE_URL ?>articles/editing/<?= $article->getIdArticle() ?>" class="col" method="POST">
                <div class="col">
                    ...
                    <input type="text" class="w-100 mt-2 bg-secondary text-white" value="<?= $article->getFactoryName()  ?>" readonly>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="col d-flex justify-content-between flex-column p-0">
                                <div class="d-flex justify-content-end"><input type="text" min="0" max="5" class="w-50 mt-5 mb-2 bg-secondary text-white" value="<?= $article->getIdArticle()  ?>" readonly></div>
                                <div class="d-flex justify-content-end"><input type="text" min="0" class="w-50 mt-5 mb-2 bg-secondary text-white" value="<?= $article->getPrice()  ?>" readonly></div>
                                <div class=" d-flex justify-content-end"><input type="text" class="w-50 mt-5 mb-2 bg-secondary text-white" value="<?= $article->getStock()  ?>" readonly></div>
                            </div>
                        </div>
                    </div>
